document.addEventListener('DOMContentLoaded', () => {
    ...
    const startDate = new Date(2024, 3, 16);
...
if (noBtn && yesBtn && btnContainer) {
    let scale = 1;

    // Hacemos que el contenedor tenga posición relativa
    btnContainer.style.position = 'relative';

    const moveNoButton = () => {
        const margin = 35; // margen desde los bordes
        ...
        // crecimiento del botón de sí más suave
        scale += 0.05;
